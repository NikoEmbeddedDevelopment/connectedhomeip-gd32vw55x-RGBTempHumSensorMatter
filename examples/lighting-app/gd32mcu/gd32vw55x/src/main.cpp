...
static void main_task(void * pvParameters)
{
    ...
    if (ret != CHIP_NO_ERROR)
    {
        GD32VW55x_LOG("GetAppTask().StartAppTask() failed");
        appError(ret);
    }
...
int main(void)
{
    ...
    GD32VW55x_LOG("\r\n==================================================\r\n");
    GD32VW55x_LOG("chip-gd32vw553-lighting+sensor-example starting Version %d", CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION);
    GD32VW55x_LOG("==================================================\r\n");

    // Optional debug LED toggle task
