...
private:
    ...
    int16_t mMinMeasuredTempCentiCelsius = TEMP_VALUE_INVALID;
    int16_t mMaxMeasuredTempCentiCelsius = TEMP_VALUE_INVALID;
    ...
    uint16_t mMinMeasuredHumidityCentiPercent = HUM_VALUE_INVALID;
    uint16_t mMaxMeasuredHumidityCentiPercent = HUM_VALUE_INVALID;
