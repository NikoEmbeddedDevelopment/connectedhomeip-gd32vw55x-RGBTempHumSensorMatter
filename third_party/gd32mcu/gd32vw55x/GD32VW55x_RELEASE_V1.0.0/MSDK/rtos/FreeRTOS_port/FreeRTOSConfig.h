...
#define configTICK_RATE_HZ              ( ( unsigned long long ) 1000 )
#define configMAX_PRIORITIES            ( 56 ) //6
...
#define configCHECK_FOR_STACK_OVERFLOW  1//2
#else
...
#define configTIMER_TASK_PRIORITY       (16 + 3) // TASK_PRIO_APP_BASE + 3
