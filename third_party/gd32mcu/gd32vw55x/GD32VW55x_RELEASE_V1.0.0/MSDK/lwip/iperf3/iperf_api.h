...
float  iperf_get_test_reporter_interval( struct iperf_test* ipt );
float  iperf_get_test_stats_interval( struct iperf_test* ipt );
...
void   iperf_set_test_reporter_interval( struct iperf_test* ipt, float reporter_interval );
void   iperf_set_test_stats_interval( struct iperf_test* ipt, float stats_interval );
