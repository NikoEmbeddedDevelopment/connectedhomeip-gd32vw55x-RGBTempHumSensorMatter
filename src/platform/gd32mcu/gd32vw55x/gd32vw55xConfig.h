...
public:
    ...
    static const char kConfigNamespace_ChipCommit[];
    ...
    //Commit flag
    static const Key kCommitKey_CommitFlag;
    ...
    static void *get_gd32vw55x_nvds_falsh_handle(void);

    static void RunConfigUnitTest(void);

private:
    static void * nvds_flash_handle;
};

struct GD32VW55xConfig::Key
{
...
inline bool GD32VW55xConfig::Key::operator==(const Key & other) const
{
    return strcmp(Namespace, other.Namespace) == 0 && strcmp(Name, other.Name) == 0;
}

inline void * GD32VW55xConfig::get_gd32vw55x_nvds_falsh_handle(void)
{
    return nvds_flash_handle;
}
