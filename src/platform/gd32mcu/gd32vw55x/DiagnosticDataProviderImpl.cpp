...
#include <platform/gd32mcu/gd32vw55x/DiagnosticDataProviderImpl.h>
...
CHIP_ERROR DiagnosticDataProviderImpl::GetNetworkInterfaces(NetworkInterface ** netifpp)
{
    ...
    {
        ifa = (struct netif *)vif_idx_to_net_if(i);
...
CHIP_ERROR DiagnosticDataProviderImpl::GetWiFiBssId(MutableByteSpan & BssId)
{
    ...
    memcpy(bssid, (uint8_t *)&vif_status.sta.bssid.array[0], 6);
...
CHIP_ERROR DiagnosticDataProviderImpl::GetWiFiChannelNumber(uint16_t & channelNumber)
{
    ...
    channelNumber = chip::DeviceLayer::Internal::GD32VW55xUtils::MapFrequencyToChannel(vif_status.chan.prim20_freq);
