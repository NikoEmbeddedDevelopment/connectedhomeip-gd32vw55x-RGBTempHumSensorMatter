...
#define MATTER_FACTORY_DATA_ADDRESS     (0x08200000)
#define MATTER_FACTORY_DATA_SIZE        (0x1000)
...
struct InternalFlashFactoryData
{
    ...
    {
        data     = reinterpret_cast<uint8_t *>(MATTER_FACTORY_DATA_ADDRESS);
        dataSize = MATTER_FACTORY_DATA_SIZE;
...
struct ExternalFlashFactoryData
{
    ...
    uint8_t mFactoryDataBuffer[MATTER_FACTORY_DATA_SIZE];
};
...
public:
    ...
    CHIP_ERROR GetDiscoverMode(uint16_t & discovermode);

private:
    static constexpr uint8_t kDACPrivateKeyLength = 32;
    static constexpr uint8_t kDACPublicKeyLength  = 65;
    static constexpr uint16_t kFactoryDataPartitionSize    = MATTER_FACTORY_DATA_SIZE;
    static constexpr uint32_t kFactoryDataPartitionAddress = MATTER_FACTORY_DATA_ADDRESS;
