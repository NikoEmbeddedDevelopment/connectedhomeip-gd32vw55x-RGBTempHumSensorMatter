...
CHIP_ERROR ChipDnssdInit(DnssdAsyncReturnCallback initCallback, DnssdAsyncReturnCallback errorCallback, void * context)
{
    ...
    int Gd32vw55x_error  = 0;

    Gd32vw55x_error = mDNSResponderInit();
    VerifyOrExit(Gd32vw55x_error == 0, error = CHIP_ERROR_INTERNAL);

exit:
    if (Gd32vw55x_error != 0)
    {
        ChipLogError(DeviceLayer, "Gd32vw55x mdns internal error");
    }
