...
private:
    ...
    static void Gd32WiFiStationConnectedHandler(void *eloop_data, void *user_ctx);
    static void Gd32WiFiStationDisconnectedHandler(void *eloop_data, void *user_ctx);
    static void Gd32WiFiScanCompletedHandler(void *eloop_data, void *user_ctx);
    static void Gd32GotIPHandler(void *eloop_data, void *user_ctx);
    //void DHCPProcess(void);
    //static void DHCPProcessThread(void * param);
    static int register_wifi_event();
};
 ...
 * that are specific to the GD32VW55x platform.
 */
