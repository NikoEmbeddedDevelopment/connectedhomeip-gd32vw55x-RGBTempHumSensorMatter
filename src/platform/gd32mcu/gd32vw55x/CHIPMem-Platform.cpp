...
CHIP_ERROR MemoryAllocatorInit(void * buf, size_t bufSize)
{
    ...
    {
        printf("ABORT: chip::Platform::MemoryInit() called twice.\n");
        //abort();
    }
...
void MemoryAllocatorShutdown()
{
    if (--memoryInitialized < 0)
    {
        printf("ABORT: chip::Platform::MemoryShutdown() called twice.\n");
        //abort();
    }
}
