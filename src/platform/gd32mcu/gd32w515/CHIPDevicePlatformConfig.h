...
#define CHIP_DEVICE_CONFIG_LWIP_WIFI_STATION_IF_NAME "gd32w515"
...
#define CHIP_DEVICE_CONFIG_WIFI_AP_PASSWORD "12345678"
#define CHIP_DEVICE_CONFIG_WIFI_AP_CHANNEL 8
