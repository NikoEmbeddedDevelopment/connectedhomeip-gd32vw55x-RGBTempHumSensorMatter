...
/**
 * Concrete implementation of the ConfigurationManager singleton object for the gd32w515 platform.
 */
class ConfigurationManagerImpl : public Internal::GenericConfigurationManagerImpl<Internal::GD32W515Config>
{
public:
