...
#include "platform/gd32mcu/gd32w515/DiagnosticDataProviderImpl.h"
...
{
    // heap_info_t heap;
    // Internal::GDW515Utils::heap_usage(&heap);
                                                     ...
                                                     uint64_t & count)
{
    ...
    // Internal::GDW515Utils::unpack_xtlv_buf(tlv_buf, buflen, &cnt, &cnt_ge40);
